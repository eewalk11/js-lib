...
EeWalk11.isElement = function(arg0)
{
	...
	return EeWalk11.isElementDefined() ?
 ...
 * @param {String} arg0 The element ID, an Element object, or a jQuery object. A jQuery ID selector
 * string is a valid input, but the preceding "#" will be removed in the returned string.
 * @return {String} The element ID, false on failure.
 */
EeWalk11.toElementId = function(arg0)
{
	...
	{
		return arg0.length ?
			(arg0.substr(0, 1) === "#" ? arg0.substr(1) : arg0)
			: false;
	}
